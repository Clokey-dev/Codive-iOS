...
final class HomeDIContainer {
    ...
    private lazy var homeCategoryAPIService: HomeCategoryAPIServiceProtocol = {
        return HomeCategoryAPIService()
    }()
    ...
    private lazy var homeDatasource: HomeDatasource = {
        HomeDatasource(locationService: locationService, apiService: homeCategoryAPIService)
    }()
